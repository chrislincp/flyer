...
import { View, Easing, Animated, TouchableWithoutFeedback, BackHandler } from 'react-native'
...
export default class Modal extends React.Component {
   ...
   */
  render() {
    const { position, scale, opacity, modalVisible } = this.state
    const { children, animationType, maskStyle, style, bodyStyle, offset } = this.props
    if (!modalVisible) {
      return null
    }
